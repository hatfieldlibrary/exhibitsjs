...
var bookReaderElem = angular.element(document.getElementById('#BookReader'));
var brContainerElem = angular.element(document.getElementById('#BRcontainer'));
var bookReaderLogoElem = angular.element(document.getElementById("#BookReader a.logo"));
var brZoomElem = angular.element(document.getElementById('#BRzoom'));
var brToolbarPlayElem = angular.element(document.getElementById('#BRtoolbar .play'));
var brToolbarPauseElem = angular.element(document.getElementById('#BRtoolbar .pause'));
var brToolbarElem = angular.element(document.getElementById('#BRtoolbar'));
var brPageViewElem = angular.element(document.getElementById('#BRpageview'));
var brPagedDiv1up = angular.element(document.getElementById('.BRpagediv1up'));
var brToolbarModeTwo = angular.element(document.getElementsByTagName('#BRtoolbar .BRtoolbarmode2'));
var brToolbarMode1 = angular.element(document.getElementsByTagName('#BRtoolbar .BRtoolbarmode1'));
...
// init()
//______________________________________________________________________________
BookReader.prototype.init = function(window, element) {
   ...
   // var params = this.paramsFromFragment(window.location.hash);
    ...
    bookReaderElem.empty();

    this.initToolbar(this.mode, this.ui); // Build inside of toolbar div
   // bookReaderElem.append("<div id='BRcontainer'></div>");
    //$("#BRcontainer").append("<div id='BRpageview'></div>");
    bookReaderElem.append("<div id='BRcontainer'></div>");
    brContainerElem.append("<div id='BRpageview'></div>");

    //$("#BRcontainer").bind('scroll', this, function(e) {
    brContainerElem.bind('scroll', this, function(e) {
        e.data.loadLeafs();
    });
    ...
    this.startLocationPolling();
           ...
           /*
    element.bind('resize', this, function(e) {
        //console.log('resize!');
        if (1 == e.data.mode) {
            //console.log('centering 1page view');
            e.data.centerPageView();
            brPageViewElem.empty()
            ...
            if (e.data.twoPage.autofit) {
                ...
                if (e.data.twoPage.totalWidth < brContainerElem.attr('clientWidth')) {
                    center.percentageX = 0.5;
                    doRecenter = true;
                }
                if (e.data.twoPage.totalHeight < brContainerElem.attr('clientHeight')) {
       ...
       */
    brPagedDiv1up.bind('mousedown', this, function(e) {
...
BookReader.prototype.setDragHandler = function(div) {
    ...
    $(div).unbind('mousedown').bind('mousedown', function(e) {
        ...
        var startX    = e.pageX;
        var startY    = e.pageY;
        var startTop  = brContainerElem.attr('scrollTop');
        var startLeft =  brContainerElem.attr('scrollLeft');
    ...
    $(div).unbind('mousemove').bind('mousemove', function(ee) {
        ...
        if (this.dragging) {
            brContainerElem.attr('scrollTop', brContainerElem.attr('scrollTop') - offsetY);
            brContainerElem.attr('scrollLeft', brContainerElem.attr('scrollLeft') - offsetX);
        }
...
BookReader.prototype.drawLeafsOnePage = function() {
    ...
    var scrollTop = brContainerElem.attr('scrollTop');
    var scrollBottom = scrollTop + brContainerElem.height();
    ...
    //var viewWidth = brPageViewElem.width(); //includes scroll bar width
    var viewWidth = brContainerElem.attr('scrollWidth');
...
BookReader.prototype.resizePageView = function() {
    var i;
    var viewHeight = 0;
    //var viewWidth  = brContainerElem.width(); //includes scrollBar
    var viewWidth  = brContainerElem.attr('clientWidth');

    var oldScrollTop  = brContainerElem.attr('scrollTop');
    var oldScrollLeft = brContainerElem.attr('scrollLeft');
    var oldPageViewHeight = brPageViewElem.offsetHeight();
    var oldPageViewWidth = brPageViewElem.offsetWidth();
    ...
    brPageViewElem.height(viewHeight);
    brPageViewElem.width(viewWidth);

    var newCenterY = scrollRatio*viewHeight;
    var newTop = Math.max(0, Math.floor( newCenterY - brContainerElem.height()/2 ));
    brContainerElem.attr('scrollTop', newTop);

    // We use clientWidth here to avoid miscalculating due to scroll bar
    var newCenterX = oldCenterX * (viewWidth / oldPageViewWidth);
    var newLeft = newCenterX - brContainerElem.attr('clientWidth') / 2;
    newLeft = Math.max(newLeft, 0);
    brContainerElem.attr('scrollLeft', newLeft);
...
BookReader.prototype.centerX1up = function() {
    var centerX;
    if (brPageViewElem.width() < brContainerElem.attr('clientWidth')) { // fully shown
        centerX = brPageViewElem.width();
    } else {
        centerX = brContainerElem.attr('scrollLeft') + brContainerElem.attr('clientWidth') / 2;
    }
...
BookReader.prototype.centerY1up = function() {
    var centerY = brContainerElem.attr('scrollTop') + brContainerElem.height() / 2;
...
BookReader.prototype.centerPageView = function() {
    ...
    var scrollWidth  = brContainerElem.attr('scrollWidth');
    var clientWidth  =  brContainerElem.attr('clientWidth');
    //console.log('sW='+scrollWidth+' cW='+clientWidth);
    if (scrollWidth > clientWidth) {
        brContainerElem.attr('scrollLeft', (scrollWidth-clientWidth)/2);
    }
...
BookReader.prototype.jumpToPage = function(pageNum) {
    ...
    if ('undefined' != typeof(pageIndex)) {
        ...
        brContainerElem.attr('scrollTop', leafTop);
        return true;
    }
...
BookReader.prototype.jumpToIndex = function(index, pageX, pageY) {
    ...
    if (2 == this.mode) {
        ...
        if (pageY) {
            ...
            offset -= brContainerElem.attr('clientHeight') >> 1;
        ...
        if (pageX) {
            ...
            offset -= brContainerElem.attr('clientWidth') >> 1;
            leafLeft += offset;
        }

        //brContainerElem.attr('scrollTop', leafTop);
        brContainerElem.animate({scrollTop: leafTop, scrollLeft: leafLeft },'fast');
    }
}
...
BookReader.prototype.prepareTwoPageView = function(centerPercentageX, centerPercentageY) {
    brContainerElem.empty();
    brContainerElem.css('overflow', 'auto');
    ...
    brContainerElem.append('<div id="BRtwopageview"></div>');
    ...
    if (this.twoPage.totalWidth < brContainerElem.attr('clientWidth')) {
        centerPercentageX = 0.5;
    }
    if (this.twoPage.totalHeight < brContainerElem.attr('clientHeight')) {
...
BookReader.prototype.prepareTwoPagePopUp = function() {
    ...
    $(this.leafEdgeR).bind('mousemove', this, function(e) {
        ...
        $(e.data.twoPagePopUp).css({
            left: e.pageX- brContainerElem.offset().left + brContainerElem.scrollLeft() + 20 + 'px',
            top: e.pageY - brContainerElem.offset().top + brContainerElem.scrollTop() + 'px'
        });
    });
    ...
    $(this.leafEdgeL).bind('mousemove', this, function(e) {
        ...
        //           (https://bugs.edge.launchpad.net/gnubook/+bug/327456)        
        $(e.data.twoPagePopUp).css({
            left: e.pageX - brContainerElem.offset().left + brContainerElem.scrollLeft() - $(e.data.twoPagePopUp).width() - 25 + 'px',
            top: e.pageY-brContainerElem.offset().top + brContainerElem.scrollTop() + 'px'
        });
    });
}
...
BookReader.prototype.getIdealSpreadSize = function(firstIndex, secondIndex) {
    ...
    var maxLeafEdgeWidth   = parseInt(brContainerElem.attr('clientWidth') * 0.1);
    ideal.totalLeafEdgeWidth     = Math.min(totalLeafEdgeWidth, maxLeafEdgeWidth);

    var widthOutsidePages = 2 * (this.twoPage.coverInternalPadding + this.twoPage.coverExternalPadding) + ideal.totalLeafEdgeWidth;
    var heightOutsidePages = 2* (this.twoPage.coverInternalPadding + this.twoPage.coverExternalPadding);

    ideal.width = (brContainerElem.width() - widthOutsidePages) >> 1;
    ideal.width -= 10; // $$$ fudge factor
    ideal.height = brContainerElem.height() - heightOutsidePages;
...
BookReader.prototype.getSpreadSizeFromReduce = function(firstIndex, secondIndex, reduce) {
    ...
    var totalLeafEdgeWidth = parseInt(this.numLeafs * 0.1);
    var maxLeafEdgeWidth   = parseInt(brContainerElem.attr('clientWidth') * 0.1); // $$$ Assumes leaf edge width constant at all zoom levels
...
BookReader.prototype.twoPageSetCursor = function() {
    ...
    if ( ($('#BRtwopageview').width() > brContainerElem.attr('clientWidth')) ||
        ($('#BRtwopageview').height() > brContainerElem.attr('clientHeight')) ) {
...
BookReader.prototype.prepareFlipRightToLeft = function(nextL, nextR) {
    ...
    //console.log(' prepareRTL changing nextL ' + nextL + ' to right: ' + brContainerElem.width()-gutter);
...
BookReader.prototype.twoPageGetViewCenter = function() {
    ...
    var containerOffset = brContainerElem.offset();
    var viewOffset = $('#BRtwopageview').offset();
    center.percentageX = (containerOffset.left - viewOffset.left + (brContainerElem.attr('clientWidth') >> 1)) / this.twoPage.totalWidth;
    center.percentageY = (containerOffset.top - viewOffset.top + (brContainerElem.attr('clientHeight') >> 1)) / this.twoPage.totalHeight;
...
BookReader.prototype.twoPageCenterView = function(percentageX, percentageY) {
    ...
    var containerClientWidth = brContainerElem.attr('clientWidth');
    var intoViewX = percentageX * viewWidth;

    var viewHeight = $('#BRtwopageview').height();
    var containerClientHeight = brContainerElem.attr('clientHeight');
    ...
    if (viewWidth < containerClientWidth) {
        ...
        brContainerElem.scrollLeft(intoViewX - (containerClientWidth >> 1));
    }
    ...
    if (viewHeight < containerClientHeight) {
        ...
        brContainerElem.scrollTop(intoViewY - (containerClientHeight >> 1));
    }
}
...
BookReader.prototype.printPage = function() {
    ...
    /* iframe implementation
     ...
     position: 'absolute',
     top:      '20px',
     left:     (brContainerElem.width()-400)/2 + 'px',
     width:    '400px',
     padding:  "20px",
...
BookReader.prototype.showEmbedCode = function() {
    ...
    $(this.embedPopup).css({
        position: 'absolute',
        top:      '20px',
        left:     (brContainerElem.attr('clientWidth')-400)/2 + 'px',
        width:    '400px',
        padding:  "20px",
        border:   "3px double #999999",
        zIndex:   3,
...
BookReader.prototype.autoToggle = function() {
    ...
    if (null == this.autoTimer) {
        ...
        brToolbarPlayElem .hide();
        brToolbarPauseElem.show();
...
BookReader.prototype.autoStop = function() {
    if (null != this.autoTimer) {
        ...
        this.flipSpeed = 'fast';
        brToolbarPauseElem.hide();
        brToolbarPlayElem .show();
        this.autoTimer = null;
    }
}
...
BookReader.prototype.initToolbar = function(mode, ui) {
    ...
    bookReaderElem.append("<div id='BRtoolbar'>"
    ...
    if (ui == "embed") {
        bookReaderLogoElem.attr("target","_blank");
    }

    // $$$ turn this into a member variable
    var jToolbar = brToolbarElem; // j prefix indicates jQuery object
...
BookReader.prototype.switchToolbarMode = function(mode) {
    if (1 == mode) {
        // 1-up     
      //   brToolbarModeTwo.style.display = 'none';
     //    brToolbarMode1.style.display = 'inline';
    } else {
        // 2-up
     //    brToolbarMode1.style.display = 'none';
     //    brToolbarModeTwo.style.display = 'inline';
    }
}
